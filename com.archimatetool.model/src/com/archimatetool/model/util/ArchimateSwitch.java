...
public class ArchimateSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case IArchimatePackage.DOMAIN: {
				IDomain domain = (IDomain)theEObject;
				T result = caseDomain(domain);
				if (result == null) result = caseCompositeElement(domain);
				if (result == null) result = caseArchimateElement(domain);
				if (result == null) result = caseArchimateConcept(domain);
				if (result == null) result = caseArchimateModelObject(domain);
				if (result == null) result = caseCloneable(domain);
				if (result == null) result = caseDocumentable(domain);
				if (result == null) result = caseProperties(domain);
				if (result == null) result = caseAdapter(domain);
				if (result == null) result = caseNameable(domain);
				if (result == null) result = caseIdentifier(domain);
				if (result == null) result = caseFeatures(domain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
