...
public class ArchiLabelProvider {
    ...
    public String getRelationshipSentence(EClass relationshipType, IArchimateConcept source, IArchimateConcept target) {
        ...
        switch(relationshipType.getClassifierID()) {
            ...
            case IArchimatePackage.BELONGING_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_42, nameSource, nameTarget);
                
            case IArchimatePackage.PERFORMANCE_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_45, nameSource, nameTarget);
            ...
            case IArchimatePackage.REQUIRE_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_54, nameSource, nameTarget);
                
            case IArchimatePackage.SUPPORT_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_57, nameSource, nameTarget);
                
            case IArchimatePackage.PLAY_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_60, nameSource, nameTarget);
                
            case IArchimatePackage.PARTICIPATE_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_63, nameSource, nameTarget);
                
            case IArchimatePackage.PROVIDE_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_66, nameSource, nameTarget);
                
            case IArchimatePackage.AUTOMATE_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_69, nameSource, nameTarget);
               
            case IArchimatePackage.MEET_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_72, nameSource, nameTarget);
            
            case IArchimatePackage.INTERFACE_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_75, nameSource, nameTarget);
                
            case IArchimatePackage.IMPACT_RELATIONSHIP:
                return NLS.bind(Messages.ArchiLabelProvider_78, nameSource, nameTarget);
    ...
    public String getRelationshipPhrase(EClass eClass, boolean reverseDirection) {
        ...
        switch(eClass.getClassifierID()) {
            ...
            case IArchimatePackage.BELONGING_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_43 : Messages.ArchiLabelProvider_44;
            
            case IArchimatePackage.PERFORMANCE_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_46 : Messages.ArchiLabelProvider_47;
            ...
            case IArchimatePackage.REQUIRE_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_55 : Messages.ArchiLabelProvider_56;
                
            case IArchimatePackage.SUPPORT_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_58 : Messages.ArchiLabelProvider_59;
            
            case IArchimatePackage.PLAY_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_61 : Messages.ArchiLabelProvider_62;
                
            case IArchimatePackage.PARTICIPATE_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_64 : Messages.ArchiLabelProvider_65;
                
            case IArchimatePackage.PROVIDE_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_67 : Messages.ArchiLabelProvider_68;
                
            case IArchimatePackage.AUTOMATE_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_70 : Messages.ArchiLabelProvider_71;
            
            case IArchimatePackage.MEET_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_73 : Messages.ArchiLabelProvider_74;
                
            case IArchimatePackage.INTERFACE_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_76 : Messages.ArchiLabelProvider_77;
                
            case IArchimatePackage.IMPACT_RELATIONSHIP:
                return reverseDirection ? Messages.ArchiLabelProvider_79 : Messages.ArchiLabelProvider_80;
