...
public class CityServiceFigure extends AbstractTextControlContainerFigure {

	public CityServiceFigure() {
	...
	protected void drawIconImage(Graphics graphics) {
		...
		ImageData data = new ImageData(path + "/" + IArchiImages.ICON_CITY_SERVICE_IMAGE);
