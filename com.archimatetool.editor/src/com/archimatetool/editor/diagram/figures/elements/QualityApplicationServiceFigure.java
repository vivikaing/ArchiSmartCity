...
/**
 * Quality of Application Service Figure
 * 
 * @author Viviana Bastidas
 */

public class QualityApplicationServiceFigure extends AbstractTextControlContainerFigure {

	public QualityApplicationServiceFigure() {
	...
	protected void drawIconImage(Graphics graphics) {
		...
		ImageData data = new ImageData(path + "/" + IArchiImages.ICON_QUALITY_APPLICATION_SERVICE_IMAGE);
