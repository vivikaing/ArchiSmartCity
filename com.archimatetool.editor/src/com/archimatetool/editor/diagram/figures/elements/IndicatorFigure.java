...
/**
 * Figure for a Indicator
 * 
 * @author Viviana Bastidas
 */

public class IndicatorFigure extends AbstractMotivationFigure {
	public IndicatorFigure() {
    }
	...
	protected void drawIconImage(Graphics graphics) {
		...
		ImageData data = new ImageData(path + "/" + IArchiImages.ICON_INDICATOR_IMAGE);
